...
func (b *Bot) Setup() {
	...
	cmd := command.NewHandler(b.registration, b.sub, b.payment, b.log, b.bot)
	cb := callback.NewHandler(b.state, b.sub, b.payment, b.log, b.bot)
	...
	b.bot.Handle("/confirm_payment", AdminOnly(b.cfg)(cmd.ConfirmPayment))
}
